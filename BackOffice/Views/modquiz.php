                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Modifier quiz </h3>
                                        </div>
                                        <hr>
                                        <form action="modquiz_form.php" method="POST"  >
                                            <input type="hidden" name="id" value="<?=$quiz["id"]?>">
                                            <div class="form-group">
                                                <label >Titre</label>
                                                <input type="text" name="titre"value="<?php echo $quiz["titre"]?>" class="form-control"  >
                                               
                                            </div>
                                            <div class="form-group">
                                                <label >Questions</label>
                                                <input type="text" name="questions" value="<?php echo $quiz["questions"]?>" class="form-control" >
                                                
                                            </div>
                                            <div class="form-group">
                                                <label >Reponses</label>
                                                <input type="text" name="reponses" value="<?php echo $quiz["reponses"]?>" class="form-control" >
                                                
                                            </div>
                                            <div class="form-group">
                                                <label >id cours</label>
                                                <input type="number"  name="id_cours" value="<?php echo $quiz["id_cours"]?>" class="form-control" >
