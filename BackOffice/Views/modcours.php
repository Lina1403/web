<?php
    ...
    $req ="select * from cours where id = $id";
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Modifier Cours </h3>
                                        </div>
                                        <hr>
                                        <form action="modcoursform.php" method="POST"  >
                                            <input type="hidden" name="id" value="<?=$cours["id"]?>">
                                            <div class="form-group">
                                                <label >Titre</label>
                                                <input type="text" name="titre"value="<?php echo $cours["titre"]?>" class="form-control"  >
                                               
                                            </div>
                                            <div class="form-group">
                                                <label >Description</label>
                                                <input type="text" name="description" value="<?php echo $cours["description"]?>" class="form-control" >
                                                
                                            </div>
                                            <div class="form-group">
                                                <label >id user</label>
                                                <input type="number"  name="id_user" value="<?php echo $cours["id_user"]?>" class="form-control" >
