...
<div id="right-panel" class="right-panel">
                                        ...
                                        <tr>
                                          ...
                                          ?>
                                                  <tr>
                                                      ...
                                                      <td><?php echo nl2br($ligne["questions"]);?></td>
                                                      <td><?php echo nl2br($ligne["reponses"]);?></td>
                                                      <td><?php echo $ligne["id_cours"];?></td>
        ...
        <div>
            <button type="button" class="btn btn-primary btn-lg" style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="ajoutquiz.php">Ajouter</a>
            </button>
            <button type="button" class="btn btn-primary btn-lg" style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="trititre.php">Tri</a>
            </button>
          </div>
