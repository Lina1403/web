        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <?php }  ?>
                    <a href="listquiz.php" class="nav-item nav-link">Quiz</a>
                    <a href="listcours.php" class="nav-item nav-link active">Courses</a>
                    </div>
        ...
        <div class="container py-5">
            ...
            <?php
              ...
              if (isset($_POST["search"])) {
                  ...
                  $query = "SELECT * FROM cours WHERE titre LIKE '%$searchTerm%'";
              } else {
              ...
              if ($rep->rowCount() > 0) {
                ...
                <div class="col-lg-4 col-md-6 pb-4">
                    ...
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="detail.html">
                        ...
                        <h2 class="text-center text-white px-3"><?php echo $ligne["titre"];?></h2>
                            <h2 class="text-center text-white px-3"><?php echo $ligne["description"];?></h2>
                ...
                ?>
                  <form method="POST">
                        <input type="text" name="search-area" placeholder="Search for a course">
